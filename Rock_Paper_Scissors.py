...
def rock_paper_scissors():
    ...
    if response == "yes":
        while True:
            ...
            user_input = input("Would you like to choose rock, paper, or scissors? ").lower()
            if user_input == "rock":
            ...
            if user_input == "scissors":
                if computer_input == "rock":
                    ...
                    print("Alert: A Quantum Entanglement has been detected in the Rock, Paper, Scissors matrix. It seems the universe can't decide either. Please stand by while we attempt to debug reality and figure out if we're dealing with a glitch in the matrix or just an epic showdown of eternal indecision.")
            if user_input == "quit":
                print("You have quit")
                break
    elif response == "no":
